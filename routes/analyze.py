...
from services.llm import extract_structured_analysis, extract_timeline, sort_timeline
...
def analyze():
    ...
    return jsonify({"status": "success", "analysis": analysis, "timeline": timeline, "context_id": context_id})
